...
class MysqlDataTypes
{
     ...
     * system, these definitions will look familiar to you. The following list shows the common numeric data types and
     * their descriptions:
     */
     ...
     * 32768 to 32767. If unsigned, the allowable range is from 0 to 65535. You can specify a width of up to
     * 5 digits.
     */
    const SMALLINT = 'SMALLINT';

    /**
     * EDIUMINT - A medium-sized integer that can be signed or unsigned. If signed, the allowable range is
     ...
     * 9223372036854775808 to 9223372036854775807. If unsigned, the allowable range is from 0 to 18446744073709551615.
     ...
     * decimals and 10 is the total number of digits (including decimals). Decimal precision can go to 24 places for
     * a FLOAT.
     */
    const FLOAT = 'FLOAT';
     ...
     * 4 is the number of decimals. Decimal precision can go to 53 places for a DOUBLE. REAL is a synonym for DOUBLE.
     */
    const DOUBLE = 'DOUBLE';
    ...
    /**
     * DATE - A date in YYYY-MM-DD format, between 1000-01-01 and 9999-12-31. For example, December 30th, 1973 would
     * be stored as 1973-12-30.
     */
    const DATE = 'DATE';

    /**
     * DATETIME - A date and time combination in YYYY-MM-DD HH:MM:SS format, between 1000-01-01 00:00:00 and
    ...
    /**
     * TIMESTAMP - A timestamp between midnight, January 1, 1970 and sometime in 2037. This looks like the previous
     * DATETIME format, only without the hyphens between numbers; 3:30 in the afternoon on December 30th, 1973 would
    ...
    /**
     * VARCHAR(M) - A variable-length string between 1 and 255 characters in length; for example VARCHAR(25). You must
    ...
    /**
     * TEXT - A field with a maximum length of 65535 characters. BLOBs are "Binary Large Objects" and are used to
     * store large amounts of binary data, such as images or other types of files. Fields defined as TEXT also hold
     * large amounts of data; the difference between the two is that sorts and comparisons on stored data are case
     * sensitive on BLOBs and are not case sensitive in TEXT fields. You do not specify a length with BLOB or TEXT.
     */
    const TEXT = 'TEXT';
    ...
    /**
     * TINYTEXT - A BLOB or TEXT column with a maximum length of 255 characters. You do not specify a length with
    ...
    /**
     * MEDIUMTEXT - A BLOB or TEXT column with a maximum length of 16777215 characters. You do not specify a length
     * with MEDIUMBLOB or MEDIUMTEXT.
     */
    ...
    /**
     * LONGTEXT - A BLOB or TEXT column with a maximum length of 4294967295 characters. You do not specify a length
     * with LONGBLOB or LONGTEXT.
     */
    const LONGTEXT = 'LONGTEXT';

    /**
     * ENUM - An enumeration, which is a fancy term for list. When defining an ENUM, you are creating a list of items
     * from which the value must be selected (or it can be NULL). For example, if you wanted your field to contain
     * "A" or "B" or "C", you would define your ENUM as ENUM ('A', 'B', 'C') and only those values (or NULL) could
     * ever populate that field.
     */
    const ENUM = 'ENUM';

    /**
     * JSON MySQL type from version 5.7.7
     */
    const JSON = 'JSON';
